...
hi Function     guifg=#2A7EB0 ctermfg=14
hi Statement    guifg=#C47A72 ctermfg=5
hi Keyword      guifg=#C47A72 ctermfg=5
hi PreProc      guifg=#C47A72
hi Type         guifg=#2A7EB0 ctermfg=12
hi Special      guifg=#C45A20
hi Underlined   guifg=#2A7EB0 gui=underline
hi Error        guifg=#EDE6DE guibg=#B82E18
...
hi MatchParen   guifg=#B82E18 guibg=#56180A gui=bold
...
hi PmenuSel     guifg=#090909 guibg=#B82E18
hi DiffAdd      guibg=#1e2e1a guifg=#5A7A42
hi DiffDelete   guibg=#2e1a1c guifg=#B82E18
hi DiffChange   guibg=#2e2a1a guifg=#C49A3C
hi DiffText     guibg=#3a3420 guifg=#C49A3C gui=bold
hi Title        guifg=#B82E18
hi Directory    guifg=#2A7EB0
