...
# Homebrew (if offered):
# brew install theesfeld/tap/heartbox

# RPM (if offered):
# sudo rpm -Uvh heartbox-VERSION.rpm

# deb (if offered):
# sudo dpkg -i heartbox_VERSION_amd64.deb
```
...
# cargo install --path .
# go install ./cmd/heartbox@latest
```
...
Full option reference: see [man/heartbox.1.md](man/heartbox.1.md).
